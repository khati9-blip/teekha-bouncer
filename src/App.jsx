        ...
        <div style={{maxWidth:860,margin:"0 auto",padding:"20px 16px 90px"}}>
          ...
          {page==="draft"&&(
            <DraftPage
              ...
              setShowAllPlayersModal={setShowAllPlayersModal}
              saveHighlights={saveHighlights}
              saveNotes={saveNotes}
              assignPlayer={assignPlayer}
              removePlayer={removePlayer}
              toggleSafePlayer={toggleSafePlayer}
              toggleRuledOut={toggleRuledOut}
              deletePlayer={deletePlayer}
              withPassword={withPassword}
              removeFromUnsoldPool={removeFromUnsoldPool}
              isPlayerSafeForTeam={isPlayerSafeForTeam}
              storeSet={storeSet}
            />
          )}
