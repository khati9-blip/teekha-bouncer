...
export let _pitchId = "p1";
export const storeGet = (key) => sbGet(_pitchId + "_" + key);
export const storeSet = (key, val) => sbSet(_pitchId + "_" + key, val);
export const storeDel = (key) => sbDel(_pitchId + "_" + key);
